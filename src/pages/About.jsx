  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>With a strong passion for web development, I excel in designing dynamic and intuitive web applications. My skills encompass both front-end and back-end development, and I have a particular affinity for working with React, Tailwind, and Next.js.</p>
      </div>
