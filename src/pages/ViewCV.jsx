...
const ViewCV = () => {
  ...
  // Direct Safari users to open the PDF in a new tab
  ...
  return (
    <div className="pt-16 px-4 min-h-screen flex flex-col">
      ...
      {isSafari ? (
        // Safari-specific view with direct open link
        <motion.div
        ...
        >
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              Safari doesn't support downloading PDFs directly. Tap below to open the CV in a new tab.
            </p>
